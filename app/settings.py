...
if not 'FACEBOOK_APP' in vars():
    FACEBOOK_APP = os.environ('CAREERVILLAGE_FACEBOOK_APP')
FACEBOOK_APP_SETTINGS = FACEBOOK_APPS.get(FACEBOOK_APP)
if FACEBOOK_APP_SETTINGS:
    FACEBOOK_APP_ID = FACEBOOK_APP_SETTINGS.get('APP_ID')
    FACEBOOK_APP_NAMESPACE = FACEBOOK_APP_SETTINGS.get('APP_NAMESPACE')
...
LINKEDIN_APP_SETTINGS = LINKEDIN_APPS.get(LINKEDIN_APP)
if LINKEDIN_APP_SETTINGS:
    LINKEDIN_CONSUMER_KEY = LINKEDIN_APP_SETTINGS.get('CONSUMER_KEY')
    LINKEDIN_CONSUMER_SECRET = LINKEDIN_APP_SETTINGS.get('CONSUMER_SECRET')
