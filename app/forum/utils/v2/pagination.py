...
page_numbers_template = template.loader.get_template('v2/paginator/page_numbers.html')
page_sizes_template = template.loader.get_template('v2/paginator/page_sizes.html')
sort_tabs_template = template.loader.get_template('v2/paginator/sort_tabs.html')
