...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.facebook_access_token'
        db.alter_column('forum_user', 'facebook_access_token', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'User.linkedin_photo_url'
        db.alter_column('forum_user', 'linkedin_photo_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'User.facebook_email'
        db.alter_column('forum_user', 'facebook_email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'User.facebook_uid'
        db.alter_column('forum_user', 'facebook_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.facebook_access_token'
        db.alter_column('forum_user', 'facebook_access_token', self.gf('django.db.models.fields.CharField')(default='', max_length=250))

        # Changing field 'User.linkedin_photo_url'
        db.alter_column('forum_user', 'linkedin_photo_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))

        # Changing field 'User.facebook_email'
        db.alter_column('forum_user', 'facebook_email', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'User.facebook_uid'
        db.alter_column('forum_user', 'facebook_uid', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 12, 0, 0)'}),
