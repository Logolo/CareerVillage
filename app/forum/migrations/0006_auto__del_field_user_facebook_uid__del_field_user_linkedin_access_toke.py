...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('forum_user', 'facebook_uid')

        # Deleting field 'User.linkedin_access_token_expires_on'
        db.delete_column('forum_user', 'linkedin_access_token_expires_on')

        # Deleting field 'User.facebook_access_token'
        db.delete_column('forum_user', 'facebook_access_token')

        # Deleting field 'User.facebook_email'
        db.delete_column('forum_user', 'facebook_email')

        # Deleting field 'User.facebook_access_token_expires_on'
        db.delete_column('forum_user', 'facebook_access_token_expires_on')

        # Deleting field 'User.linkedin_email'
        db.delete_column('forum_user', 'linkedin_email')

        # Deleting field 'User.linkedin_access_token'
        db.delete_column('forum_user', 'linkedin_access_token')

        # Deleting field 'User.linkedin_photo_url'
        db.delete_column('forum_user', 'linkedin_photo_url')

        # Deleting field 'User.linkedin_uid'
        db.delete_column('forum_user', 'linkedin_uid')


    def backwards(self, orm):
        # Adding field 'User.facebook_uid'
        db.add_column('forum_user', 'facebook_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.linkedin_access_token_expires_on'
        db.add_column('forum_user', 'linkedin_access_token_expires_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.facebook_access_token'
        db.add_column('forum_user', 'facebook_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.facebook_email'
        db.add_column('forum_user', 'facebook_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.facebook_access_token_expires_on'
        db.add_column('forum_user', 'facebook_access_token_expires_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.linkedin_email'
        db.add_column('forum_user', 'linkedin_email',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.linkedin_access_token'
        db.add_column('forum_user', 'linkedin_access_token',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.linkedin_photo_url'
        db.add_column('forum_user', 'linkedin_photo_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.linkedin_uid'
        db.add_column('forum_user', 'linkedin_uid',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
