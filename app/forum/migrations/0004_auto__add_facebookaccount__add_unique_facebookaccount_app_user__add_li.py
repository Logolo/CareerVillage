...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_facebookaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='facebook_accounts', to=orm['forum.User'])),
            ...
            ('access_token_expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('forum', ['FacebookAccount'])

        # Adding unique constraint on 'FacebookAccount', fields ['app', 'user']
        db.create_unique('forum_facebookaccount', ['app', 'user_id'])

        # Adding model 'LinkedinAccount'
        db.create_table('forum_linkedinaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('app', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='linkedin_accounts', to=orm['forum.User'])),
            ('uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('access_token', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('access_token_expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ...
        db.send_create_signal('forum', ['LinkedinAccount'])

        # Adding unique constraint on 'LinkedinAccount', fields ['app', 'user']
        db.create_unique('forum_linkedinaccount', ['app', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'LinkedinAccount', fields ['app', 'user']
        db.delete_unique('forum_linkedinaccount', ['app', 'user_id'])

        # Removing unique constraint on 'FacebookAccount', fields ['app', 'user']
        db.delete_unique('forum_facebookaccount', ['app', 'user_id'])

        # Deleting model 'FacebookAccount'
        db.delete_table('forum_facebookaccount')

        # Deleting model 'LinkedinAccount'
        db.delete_table('forum_linkedinaccount')
