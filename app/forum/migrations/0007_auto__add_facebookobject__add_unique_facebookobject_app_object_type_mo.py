...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookObject'
        db.create_table('forum_facebookobject', (
        ...
        db.send_create_signal('forum', ['FacebookObject'])

        # Adding unique constraint on 'FacebookObject', fields ['app', 'object_type', 'model_id']
        db.create_unique('forum_facebookobject', ['app', 'object_type', 'model_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FacebookObject', fields ['app', 'object_type', 'model_id']
        db.delete_unique('forum_facebookobject', ['app', 'object_type', 'model_id'])

        # Deleting model 'FacebookObject'
        db.delete_table('forum_facebookobject')
    ...
    models = {
        ...
        'forum.facebookobject': {
            'Meta': {'unique_together': "(('app', 'object_type', 'model_id'),)", 'object_name': 'FacebookObject'},
            'app': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 15, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 16, 0, 0)'}),
