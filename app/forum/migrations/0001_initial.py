...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('forum_user', (
            ...
            ('facebook_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('facebook_email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('facebook_access_token', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('facebook_access_token_expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('linkedin_uid', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('linkedin_email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('linkedin_access_token', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('linkedin_access_token_expires_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('linkedin_photo_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        ...
        db.create_table('forum_validationhash', (
            ...
            ('expiration', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 2, 0, 0))),
        ...
        db.create_table('forum_questionsubscription', (
            ...
            ('last_view', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 1, 0, 0))),
        ))
        db.send_create_signal('forum', ['QuestionSubscription'])

        # Adding model 'Referral'
        db.create_table('forum_referral', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='referrals', null=True, to=orm['forum.User'])),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('referred_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='referred_by', to=orm['forum.User'])),
            ('action', self.gf('django.db.models.fields.related.OneToOneField')(related_name='referral', unique=True, to=orm['forum.Action'])),
            ('referred_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('forum', ['Referral'])

        # Adding M2M table for field questions on 'Referral'
        db.create_table('forum_referral_questions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('referral', models.ForeignKey(orm['forum.referral'], null=False)),
            ('node', models.ForeignKey(orm['forum.node'], null=False))
        ))
        db.create_unique('forum_referral_questions', ['referral_id', 'node_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('forum_referral')

        # Removing M2M table for field questions on 'Referral'
        db.delete_table('forum_referral_questions')
        ...
        db.delete_table('forum_cohort')

        # Removing M2M table for field educators on 'Cohort'
        db.delete_table('forum_cohort_educators')

        # Removing M2M table for field students on 'Cohort'
        db.delete_table('forum_cohort_students')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 1, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 2, 0, 0)'}),
