...
REP_TO_VOTE_UP = Setting('REP_TO_VOTE_UP', 1, MIN_REP_SET, dict(
...
REP_TO_FLAG = Setting('REP_TO_FLAG', 0, MIN_REP_SET, dict(
...
REP_TO_COMMENT = Setting('REP_TO_COMMENT', 1, MIN_REP_SET, dict(
...
REP_TO_LIKE_COMMENT = Setting('REP_TO_LIKE_COMMENT', 1, MIN_REP_SET, dict(
...
REP_TO_CLOSE_OWN = Setting('REP_TO_CLOSE_OWN', 1, MIN_REP_SET, dict(
...
REP_TO_REOPEN_OWN = Setting('REP_TO_REOPEN_OWN', 1, MIN_REP_SET, dict(
...
REP_TO_RETAG = Setting('REP_TO_RETAG', 1, MIN_REP_SET, dict(
...
REP_TO_EDIT_OTHERS = Setting('REP_TO_EDIT_OTHERS', 100, MIN_REP_SET, dict(
...
REP_TO_CLOSE_OTHERS = Setting('REP_TO_CLOSE_OTHERS', 100, MIN_REP_SET, dict(
...
REP_TO_DELETE_COMMENTS = Setting('REP_TO_DELETE_COMMENTS', 1, MIN_REP_SET, dict(
