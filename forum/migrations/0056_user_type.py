...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for user in orm['forum.user'].objects.all():
            if user.self.prop.user_type == 'student':
                user.type = 'S'
            elif user.self.prop.user_type == 'professional':
                user.type = 'P'
            elif user.self.prop.user_type == 'educator':
                user.type = 'E'
            else:
                user.type = 'S'
            user.save()
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 10, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 0, 0)'}),
