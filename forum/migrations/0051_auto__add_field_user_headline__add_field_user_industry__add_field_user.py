...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.headline'
        db.add_column('forum_user', 'headline',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'User.industry'
        db.add_column('forum_user', 'industry',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'User.headline'
        db.delete_column('forum_user', 'headline')

        # Deleting field 'User.industry'
        db.delete_column('forum_user', 'industry')
    ...
    models = {
        ...
        'forum.questionsubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 4, 0, 0)'}),
        ...
        'forum.validationhash': {
            ...
            'expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 0, 0)'}),
